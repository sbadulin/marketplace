...
// хелперы на основе https://gist.github.com/paulirish/12fb951a8b893a454b32
...
function loadPlaces(map) {
  var lat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 59.93;
  var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 30.31;
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    // Если поле поиска пустое, то скрываем поле для результатов
    if (!this.value) {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      ...
      searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">\u041D\u0435\u0442 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u043E\u0432 \u0434\u043B\u044F ' + _this.value + '</div>');
    }).catch(function (err) {
      console.error(err);
    });
  });
  ...
  searchInput.on('keyup', function (e) {
    if (![38, 40, 13].includes(e.keyCode)) {
      return; // пропускаем все нажатия кроме вверх, вниз, ввод
    }
